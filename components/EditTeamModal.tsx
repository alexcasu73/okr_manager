...
const EditTeamModal: React.FC<EditTeamModalProps> = ({
    ...
    // Update fields when currentName or currentDescription changes
    useEffect(() => {
        if (isOpen) {
            setName(currentName);
            ...
            <div className="relative bg-white dark:bg-slate-800 rounded-3xl shadow-xl w-full max-w-md mx-4 p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Edit Team</h2>
                            <p className="text-sm text-slate-500 dark:text-slate-400">Update team details</p>
                        </div>
                    </div>
                    <button
                        onClick={handleClose}
