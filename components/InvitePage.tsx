...
const InvitePage: React.FC<InvitePageProps> = ({ token, onComplete }) => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-700 flex items-center justify-center">
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-700 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-2">You've successfully joined the team.</p>
          <p className="text-slate-400 dark:text-slate-500 text-sm">Redirecting to dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-700 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-2">Invalid Invitation</h1>
          <p className="text-slate-500 dark:text-slate-400 mb-6">{error || 'This invitation link is invalid or has expired.'}</p>
          <button
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-700 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-8 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-2">You're Invited!</h1>
        ...
        <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 mb-6">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium text-slate-900 dark:text-slate-100 capitalize">{invitation.role}</span>
          </div>
        </div>
